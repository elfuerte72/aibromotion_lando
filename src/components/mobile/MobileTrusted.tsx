...
const BRANDS: Brand[] = [
  { name: "love & pay", color: "/logos/clients/lovepay-color.png", scale: "max-h-[58%]" },
  { name: "Трак Холдинг", color: "/logos/clients/trakholding-color.png", scale: "max-h-[58%]" },
  { name: "Арктика", color: "/logos/clients/arktika-color.png", scale: "max-h-[60%]" },
  { name: "РусЭко", color: "/logos/clients/ruseco-color.png", scale: "max-h-[52%]" },
];

/**
 * Mobile trusted-by — placeholder grid until the redesign lands. No
 * scroll reveals, no auto-rotation. Static colour logos in a 2-col
 * grid with brand names underneath.
 */
