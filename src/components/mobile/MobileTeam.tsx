...
const TEAM: Member[] = [
  { n: "Макс", r: "Технический директор", src: "/media/team-max.webp" },
  { n: "Антон", r: "Маркетолог, креатор", src: "/media/team-toha.webp" },
  { n: "Артём", r: "Монтажёр", src: "/media/team-tema.webp" },
];

/**
 * Mobile team. Vertical stack of 3 portrait cards — static AVIF posters
 * with a soft gradient footer. No reveals, no scroll FX.
 */
      ...
      <ul className="flex flex-col gap-4">
        {TEAM.map((m) => (
          ...
          >
            ...
            />
            <div
              className="absolute left-3.5 right-3.5 bottom-3.5 text-paper"
